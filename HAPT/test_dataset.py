...
file_name = 'pthHAPT_cnn_lstm_cnn_s2s_lstm_cnn_b64hidden24layer3_89_14070_.pth'
...
mdl = cnn_lstm_cnn_HAPT(batchsize=batch_size, device=device, hidden_size=24,
                        num_layers=3, bidirectional=True, window_size=window_size, how=how).to(device)
